...
Public Class DAL_HoaDon
    ...
    Public Sub ThemHoaDon(a As ToolStripStatusLabel, mahoadon As String, makhachhang As String, ngayhoadon As DateTime, trigiahoadon As Single)
        Dim db As New QuanLyKhachSanDataContext()
        ...
        Try
            db.SubmitChanges()
            a.Text = "Insert HOADON successful !"
        Catch
