...
Partial Public Class QuanLyKhachSanDataContext
  ...
  #End Region
	...
	Public Sub New()
		MyBase.New(Global.DTODLL.My.MySettings.Default.QuanLyKhachSanConnectionString, mappingSource)
		OnCreated
	End Sub
...
Partial Public Class THAMSO
	...
	Private _SoLuongKhachMoiPhong As Integer
	
	Private _SoLuongKhachNuocNgoai As Integer
	
	Private _HeSo As Double
	
	Private _TyLePhuThu As Integer
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_SoLuongKhachMoiPhong", DbType:="Int NOT NULL")>  _
	Public Property SoLuongKhachMoiPhong() As Integer
		Get
			Return Me._SoLuongKhachMoiPhong
		End Get
		Set
			If ((Me._SoLuongKhachMoiPhong = value)  _
						= false) Then
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_SoLuongKhachNuocNgoai", DbType:="Int NOT NULL")>  _
	Public Property SoLuongKhachNuocNgoai() As Integer
		Get
			Return Me._SoLuongKhachNuocNgoai
		End Get
		Set
			If ((Me._SoLuongKhachNuocNgoai = value)  _
						= false) Then
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_TyLePhuThu", DbType:="Int NOT NULL")>  _
	Public Property TyLePhuThu() As Integer
		Get
