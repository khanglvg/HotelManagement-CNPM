...
Public Class BLL_HoaDon
    ...
    Public Sub ThemHoaDon(tool As ToolStripLabel, mahoadon As String, makhachhang As String, ngayhoadon As DateTime, trigiahoadon As Single)
        DAL.DAL_HoaDon.Instance.ThemHoaDon(tool, mahoadon, makhachhang, ngayhoadon, trigiahoadon)
    End Sub
End Class
